...
PARAM$trainingstrategy$semilla_azar <- 125669 # Aqui poner su  primer  semilla
...
PARAM$hyperparametertuning$semilla_azar <- 125683
#------------------------------------------------------------------------------
...
hs <- makeParamSet(
  ...
  makeNumericParam("lambda_l1", lower = 0.0001, upper = 1.0),
  makeNumericParam("lambda_l2", lower = 0.0001, upper = 1.0),
  makeNumericParam("min_gain_to_split", lower = 0, upper = 1.0),
