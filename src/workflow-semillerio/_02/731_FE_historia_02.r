...
PARAM  <- list()
PARAM$experimento <- "FE7310_02"

PARAM$exp_input  <- "DR7210_02"
...
PARAM$RandomForest$semilla  <- 125669    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 125683   # cambiar por la propia semilla
