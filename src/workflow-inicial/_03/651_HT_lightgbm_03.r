...
PARAM$lgb_semilla <- 125669 # cambiar por su propia semilla
...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeNumericParam("lambda_l1", lower = 0.001, upper = 100.0),
  makeNumericParam("lambda_l2", lower = 0.001, upper = 100.0),
